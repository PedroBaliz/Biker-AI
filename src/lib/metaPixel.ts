...
export const MetaPixelEvents = {
  ...
  initiateCheckout: (value = 10.90, currency = 'BRL') => trackPixelEvent('InitiateCheckout', { value: Number(value), currency }),
  purchase: (value = 10.90, currency = 'BRL', orderId?: string) => trackPixelEvent('Purchase', { value: Number(value), currency, content_name: 'Assinatura Biker AI', order_id: orderId }),
  subscribe: (value = 10.90, currency = 'BRL', ltv = 130.80) => trackPixelEvent('Subscribe', { value: Number(value), currency, predicted_ltv: Number(ltv) }),
