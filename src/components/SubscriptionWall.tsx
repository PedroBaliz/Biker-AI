        ...
        {checkoutStep === "plans" ? (
          ...
          >
            ...
            <div className="text-center space-y-1">
              ...
              <p className="text-xs text-slate-400 font-sans max-w-md mx-auto">Acesse planilhas inteligentes recalibradas pela IA e tire suas dúvidas de treino com nosso treinador fisiologista ilimitadamente.</p>
            </div>
